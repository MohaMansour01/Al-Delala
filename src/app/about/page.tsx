        ...
        <div className="absolute inset-0 flex flex-col text-[#bf8116] text-right w-[80%] sm:w-[65%] mt-[30%] sm:mt-[16%] text-xs sm:text-sm">
          ...
          <ul className="space-y-3 sm:space-y-4 leading-5 sm:leading-6">
            ...
            <li className="flex flex-row-reverse items-start gap-2">
              <span>⮜</span>
              <span>
                نسعى إلى تمكين الأفراد والشركات من عرض <br /> منتجاتهم وخدماتهم
                بأسلوب احترافي وآمن
              </span>
            </li>
            ...
            <li className="flex flex-row-reverse items-start gap-2">
              <span>⮜</span>
              <span>
                من خلال الدلالة، يمكنك استكشاف مجموعة <br /> متنوعة من الفئات
                مثل الموضة، الجمال، <br /> الفعاليات، التعليم، الحيوانات، الحرف
                اليدوية، <br /> الرياضة، والتبرعات
              </span>
            </li>
            ...
            <li className="flex flex-row-reverse items-start gap-2">
              <span>⮜</span>
              <span>
                نحن نحرص على توفير تجربة آمنة وسلسة <br /> لجميع المستخدمين مع
                دعم متواصل <br /> وخدمة عملاء فعّالة
              </span>
            </li>
          </ul>
        </div>
